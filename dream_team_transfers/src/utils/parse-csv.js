...
const getCSVData = async (csvFile) => {
    ...
    switch (csvFile.toLowerCase()) {
        case LEAGUES: CSVData = LeaguesCSVData; break;
        case NATIONS: CSVData = NationsCSVData; break;
        case PLAYERS: CSVData = PlayersCSVData; break;
        case POSITIONS: CSVData = PositionsCSVData; break;
        case TEAMS: CSVData = TeamsCSVData; break;
        default: throw new Error('Invalid csv file');
    }
